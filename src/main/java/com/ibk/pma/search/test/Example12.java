package com.ibk.pma.search.test;
...
//        Settings settings = Settings.builder() .put("cluster.name", "javacafe-es").build();
        Settings settings = Settings.builder().put("cluster.name", "pma-cluster").put("node.name","pma-node1").build();
        ...
        do {
            ...
            for (SearchHit hit : scrollResp.getHits().getHits()) {
                ...
                System.out.println("movieNm="+movieNm+hit.getScore());
            }
